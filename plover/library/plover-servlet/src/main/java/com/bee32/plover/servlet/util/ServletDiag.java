...
public class ServletDiag {
    ...
    static <E> List<E> toList(Enumeration<E> enm) {
    ...
    public static <T> T dump(HttpServletRequest req, HttpServletResponse resp)
        ...
        out.println("Request: ");
        {
            ...
            {
                out.enter();
                for (String headerName : toList((Enumeration<String>) req.getHeaderNames())) {
            ...
            {
                out.enter();
                for (Locale locale : toList((Enumeration<Locale>) req.getLocales())) {
                    out.println(locale);
                }
                out.leave();
            }
