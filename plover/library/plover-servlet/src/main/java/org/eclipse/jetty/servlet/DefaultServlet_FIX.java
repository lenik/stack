 ...
 *
 */
public class DefaultServlet_FIX extends HttpServlet implements ResourceFactory
{
     ...
     */
    protected String getWelcomeFile(String pathInContext) throws MalformedURLException, IOException
    {
        if (_welcomes==null)
            return null;
