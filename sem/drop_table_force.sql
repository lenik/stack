--drop function drop_table_force(schema text, table_name text);

create or replace function drop_table_force(schema text, table_name text)
...
select * from drop_table_force('old', 'event');
