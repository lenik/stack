...
public class ApeUserQuery
    ...
    @Override
    protected User sem2activiti(Entity<?> semEntity) {
        com.bee32.icsf.principal.User semUser = (com.bee32.icsf.principal.User) semEntity;
        return ActivitiAdapters.semUser2activitiUser(semUser);
    }
