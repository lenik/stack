...
public class Value24A extends EndOfTermBalance {

    @Override
    String buildQueryString() {
        return Value24Assistant.buildQueryString(verified);
    }
    ...
    public void calc() {
        ...
        SQLQuery sqlQuery2 = session.createSQLQuery(Value24Assistant.buildQueryString2(verified));
