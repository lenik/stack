...
public class Value34Assistant {
    public static String buildQueryString(boolean verified) {
        ...
        sb.append("where (a.subject like '1122%' or a.subject like '2203%') ");
        sb.append("and (a.debit_side is false) and ((b.begin_time<=:date) or (c.begin_time<=:date)) ");
        if(verified) {
