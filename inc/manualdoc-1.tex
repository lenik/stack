...
\newcommand\maketxtable[3]{
    \begin{landscape}
    \begin{table}\caption{#1（#2）的数据交换规范} \centering
    \pgfplotstabletypeset[
        begin table=\begin{longtable},
        end table=\end{longtable},
        % 0      1    2     3      4        5      6    7
        ...
        alias/系统/.initial=5,
        alias/可选/.initial=5,
        columns={ 0, 1, 2, 3, 4, 系统, 类型, 6, 可选, 7 },
        columns/0/.style={ column name={}, column type=r@{}, string type,
            preproc cell content/.code={
                \pgfkeyssetvalue{/pgfplots/table/@cell content}{
                    \IfStrEqCase{####1}{
                        ...
                        {DictEntity}{典}
                        {NameDict}{典+}
                        {ProcessEntity}{过程}}[USR]
                }}},
        columns/1/.style={ column name={}, column type=c@{ }|, string type,
            preproc cell content/.code={
                \pgfkeyssetvalue{/pgfplots/table/@cell content}{
                }}},
        columns/2/.style={ column name={XML 标识符}, column type=c, verb string type },
